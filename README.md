...
- **The floor.** A 40 × 30 m room built in code: a table pit, a poker room, three banks of slot
  machines, video poker set into the bar, a cashier cage and a lounge. You walk it with WASD and
  see everyone else on it walking, standing or sitting at a table, with their name over their head.
  Press E at a table to sit down.
- **Eight games.** Blackjack, roulette (American and European wheels), craps, baccarat, Three Card
  Poker, Jacks or Better video poker, three slot machines and no-limit Texas Hold'em. Every table
  game can be played alone or in a lobby with others: public lobbies are listed for anyone at that
...
Three Card Poker deals, every video poker deal and draw, every slot reel stop), and the strategy
tables are tested cell by cell. Cards and numbers come from `crypto.getRandomValues` with
