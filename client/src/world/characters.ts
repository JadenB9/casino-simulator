...
export class Person implements Character {
  ...
  private act: { e: EmoteId | StaffGesture | LawGesture; t: number } | null = null;
  private modelY = 0;
  ...
  /** Act out an emote, or one of a dealer's motions (StaffGesture), or a punch thrown or taken (LawGesture). */
...
function gestureOf(e: EmoteId | StaffGesture | LawGesture): Gesture | undefined {
