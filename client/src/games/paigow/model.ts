// The Pai Gow Poker table as it stands on the floor: a wood body cut to the D, a padded rail
...
import { DEFAULT_FORTUNE } from '../../../../shared/src/games/paigow/rules.ts';
...
export const FLOOR_FELT = 'pg-floor-felt';
...
export function tableModel(quality: Quality): THREE.Group {
  ...
  const felt = makeFelt(DEFAULT_FORTUNE, quality === 'high' ? 520 : 320);
