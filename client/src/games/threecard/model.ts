// The Three Card Poker table as it stands on the floor: a wood body cut to the D, a padded rail
...
import { DEFAULT_PAYTABLE } from '../../../../shared/src/games/threecard/rules.ts';
...
export const FLOOR_FELT = 'tc-floor-felt';
