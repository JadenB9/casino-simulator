// Slots: seven one-player machines. Classic Sevens, Neon Nights and 5x Wild use the first cabinets
// and view (cabinet.ts, view.ts); Diamond Line, Lucky Cherries, Gold Rush and Straw, Sticks & Bricks are skins on the
...
export const slots: GameClientModule = {
  ...
  playPose: (variant) =>
    variant === 'neon' || variant === 'cherries' || variant === 'goldrush' || variant === 'pigs'
