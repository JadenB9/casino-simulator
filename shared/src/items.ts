...
export const EMOTE_ITEMS: readonly EmoteItem[] = [
  ...
  { id: 'throwback', name: 'Throw It Back', price: 150_000 * DOLLAR, about: 'Bent over, hands on the knees, rocking the hips back on the beat.' },
  { id: 'twerk', name: 'Twerk', price: 150_000 * DOLLAR, about: 'Down in a deep squat, the hips shaking fast while the rest holds still.' },
