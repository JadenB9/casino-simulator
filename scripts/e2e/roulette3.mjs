...
await page.waitForFunction(() => document.querySelector('.modal input[type=number]') || (window.casino?.table ?? window.casino?.app?.table?.session)?.view?.debug?.state().stack > 0, null, { timeout: 120000 });
